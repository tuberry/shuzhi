...
import {Fulu, ExtensionBase, Destroyable, manageSource, omit, getSelf, bindNight, _, copy} from './fubar.js';
...
class ShuZhi extends Destroyable {
    ...
    _buildWidgets() {
        this._src = manageSource(this, () => omit(this, 'systray'), {
    ...
    set interval(interval) {
        ...
        this._src.cycle.refreshSource(this._refresh);
    }
